...
export const ModernTechTheme = ({ portfolio, isPreview = false }) => {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 font-sans selection:bg-cyan-500 selection:text-black relative overflow-x-hidden">
      ...
      {/* Sticky Glass Navbar */}
      <header className="sticky top-0 z-40 bg-[#030712]/70 backdrop-blur-xl border-b border-cyan-500/20 shadow-[0_4px_30px_rgba(0,240,255,0.08)]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <a href="#hero" className="flex items-center gap-2.5 group">
            <span className="h-8 w-8 rounded-lg bg-gradient-to-br from-cyan-400 to-blue-600 text-black flex items-center justify-center font-black text-sm shadow-[0_0_12px_rgba(0,240,255,0.7)] group-hover:scale-110 transition-transform">
              &lt;/&gt;
            </span>
            <span className="font-black text-base text-white tracking-tight group-hover:text-cyan-400 transition-colors">
              {hero.name || 'Developer'}
            </span>
          </a>
          ...
          <div className="flex items-center gap-3">
            {hero.showResume && hero.resumeUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-slate-900 border border-slate-700 text-slate-200 hover:border-cyan-400 hover:text-white transition-all shadow-sm"
              >
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-black bg-gradient-to-r from-cyan-400 to-sky-400 text-slate-950 shadow-[0_0_15px_rgba(0,240,255,0.6)] hover:scale-105 transition-all"
            >
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 space-y-24">
        ...
        {/* ── 1. HERO SECTION ── */}
        <section id="hero" className="pt-6 sm:pt-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-10 sm:gap-14">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-400/30 text-cyan-300 text-xs font-bold mb-6 backdrop-blur-md shadow-[0_0_15px_rgba(0,240,255,0.15)]">
            ...
            <p className="text-lg sm:text-xl font-bold text-cyan-400/90 mt-3 flex items-center justify-center lg:justify-start gap-2">
              <span>✦</span> {hero.title || 'Full Stack Developer'}
            </p>

            <p className="text-sm sm:text-base text-slate-300 mt-5 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
