...
export const AuthLayout = ({ title, subtitle, children }) => {
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 py-8 sm:py-12 bg-[#060a14] relative overflow-x-hidden">
      {/* Ambient Cyberpunk Neon Backlights */}
      <div className="fixed top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-80 sm:w-96 h-80 sm:h-96 bg-pink-600/20 rounded-full blur-3xl pointer-events-none z-0" />
      <div className="fixed bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-80 sm:w-96 h-80 sm:h-96 bg-cyan-500/20 rounded-full blur-3xl pointer-events-none z-0" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="hidden lg:flex lg:col-span-6 flex-col justify-between space-y-8 pr-4">
            <div>
              ...
              <h2 className="text-4xl xl:text-5xl font-black text-white leading-tight mb-3">
                <span className="neon-font neon-glow-pink inline-block text-5xl xl:text-6xl mr-2">Welcome</span>
                <span className="text-white drop-shadow-[0_0_15px_rgba(0,240,255,0.85)]">Back!</span>
              </h2>
              <p className="text-cyan-100/80 text-sm xl:text-base leading-relaxed max-w-md">
                Sign in to continue your journey with NeonX — Where Innovation Meets Style.
              </p>
            </div>

            {/* Glowing Neon Portal Ring Graphic with Skyline Silhouette */}
            <div className="relative my-4 flex items-center justify-center">
              <div className="relative w-60 h-60 xl:w-64 xl:h-64 rounded-full border-4 border-cyan-400 shadow-[0_0_35px_rgba(0,240,255,0.7),inset_0_0_30px_rgba(255,0,127,0.5)] flex items-center justify-center overflow-hidden bg-gradient-to-b from-purple-950/40 to-slate-950/90">
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="bg-slate-900/60 border border-cyan-400/50 rounded-xl p-3 text-center backdrop-blur-md shadow-[0_0_12px_rgba(0,240,255,0.25)]">
              ...
              <div className="bg-slate-900/60 border border-pink-400/50 rounded-xl p-3 text-center backdrop-blur-md shadow-[0_0_12px_rgba(255,0,127,0.25)]">
          ...
          <div className="lg:col-span-6 w-full max-w-md mx-auto">
            ...
            <div className="neon-auth-card p-7 sm:p-10 shadow-2xl">
              <h1 className="text-3xl font-black text-center text-white neon-glow-cyan mb-2">
                {title}
              </h1>
              {subtitle && <p className="text-xs text-cyan-200/80 text-center mb-6">{subtitle}</p>}
              {children}
            </div>
          </div>
